...
<!-- gaya  -->
<link href="/assets/css/sigap95.css" rel="stylesheet" id="style">
<link href="/assets/css/sigap95-custom.css" rel="stylesheet" id="style">
<!-- owl carousel styles-->
            ...
            <div class="col-sm-16">
              ...
              <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav text-uppercase main-nav ">
                  ...
                  <li>
                    <a href="#">Info Hotel & Wisata Kuliner</a>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-16">
            <div class="row">
              <div class="col-sm-5">
                <img src="/assets/images/logo/sigap95-small.png" />
              </div>
            </div>
          </div>
          <div class="col-sm-16">
            <hr class="footer-divided" />
          </div>
          <div class="col-sm-16">
            <div class="row">
              <div class="col-sm-16 col-xs-16 f-nav text-center ">
              ...
              <div class="col-sm-16 col-xs-16 copyrights text-center">
              © 2016 sigap95.com</div>
            </div>
          </div>
        </div>
      </div>
