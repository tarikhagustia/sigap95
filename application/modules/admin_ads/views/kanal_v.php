    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          ...
          <br/>
          <?php echo form_open_multipart('myadmin/ads/kanal', array('name' => 'ci_form')); ?>
          <?php
          // 852.5×187.783
          ...
          <div class="form-group">
            <div class="row">
              ...
              <div class="col-md-9">
                <select class="form-control" name="ads_name">
                  <option value="KAA">Iklan Kanal 350x250 Kiri</option>
                  <option value="KAB">Iklan Kanal 350x250 Tengah</option>
                </select>
              </div>
            </div>
          </div>
              ...
              <div class="col-md-9">
                <select class="select2_multiple form-control" multiple="multiple" name="ads_location[]">
                  <?php foreach ($categorys as $key => $value): ?>
                    <option value="<?php echo $value->ads_location ?>"><?php echo $value->ads_location; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
